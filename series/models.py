...
class Series(models.Model):
    ...
    poster = models.ImageField(upload_to="series/posters", help_text='Serialning rasmi')
    backdrop = models.ImageField(upload_to="series/backdrops", null=True, blank=True, help_text='Serialning fon rasmi')
...
class Episode(models.Model):
    ...
    image = models.ImageField(upload_to="episodes/images", null=True, blank=True, help_text='Episode rasmi')
